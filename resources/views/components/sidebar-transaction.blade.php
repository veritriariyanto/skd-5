    ...
    <div class="max-w-screen-3xl flex flex-wrap items-center justify-between py-2 sm:py-3 w-full px-2 lg:px-4 ">
        <div class="flex gap-2">
            ...
            <a href="/" class="flex items-center rtl:space-x-reverse">
                <img src="{{ url('/images/assets/Wedangan-DRio-White.png') }}" class="ms-4 lg:ms-0 h-8 hidden"
                    alt="logo" />
...
<aside id="sidebar-multi-level-sidebar"
    class="fixed top-0 left-0 pt-12 sm:pt-16 z-40 w-64 h-screen transition-transform -translate-x-full "
    aria-label="Sidebar">
